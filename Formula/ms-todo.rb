...
class MsTodo < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "abeb453d63a9795ca26b5c560a3ebf7fd246a129805e68a819d47dda23cc928f"
    else
      url "https://github.com/planetaryescape/ms-todo/releases/download/v#{version}/ms-todo-v#{version}-macos-x86_64.tar.gz"
      sha256 "a2e452a8219329677e650fe3d645d6490d3bab5f919b9d78137db15369606c9e"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "9cddf419e1f41dad197b781a34f253962f3392376b0956091c35a7a41fc1b250"
    end
  end
